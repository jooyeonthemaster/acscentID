...
### analysis_results (AI 이미지 분석 결과, ~1475건)
  ...
  product_type (varchar: idol_image|figure_diffuser|graduation|chemistry_set|saju_perfume - 프로그램 유형),
...
### orders (주문, ~25건) ★매출 분석 핵심 테이블
  ...
  status (text: awaiting_payment|pending|paid|preparing|shipping|delivered|cancel_requested|cancelled),
