      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md max-h-[90svh] overflow-y-auto bg-[var(--paper)] rounded-[6px] border border-[var(--line)] z-50 p-6"
          >
