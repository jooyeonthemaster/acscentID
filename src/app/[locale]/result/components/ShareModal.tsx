...
export function ShareModal({
  ...
  const handleImageShare = async () => {
    ...
    try {
      ...
      if (!blob) throw new Error(t('imageGenFailed'))
          ...
          >
            ...
            <div className="p-5 space-y-3">
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-bold text-slate-900">{t('imageShare')}</p>
                  <p className="text-xs text-slate-500">
                    {t('imageShareDesc')}
                  </p>
                </div>
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-bold text-slate-900">{t('imageSave')}</p>
                  <p className="text-xs text-slate-500">
                    {t('imageSaveDesc')}
                  </p>
                </div>
                  ...
                  >
                    <div className="w-full max-w-[455px] h-full flex flex-col bg-black">
                      ...
                      <div className="flex items-center justify-between px-4 py-3 bg-black">
                        ...
                        <span className="text-white font-bold">{t('preview')}</span>
                        <button
                          onClick={handleClosePreview}
                          className="p-2 hover:bg-white/10 rounded-full transition-colors"
                        >
                      ...
                      <div className="p-4 bg-black">
                        ...
                        >
                          ...
                          {isGenerating ? t('saving') : t('saveAsImage')}
                        </button>
                      </div>
                    </div>
                  </motion.div>
