  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-3">
        ...
        <div>
          <h2 className="text-lg font-black text-slate-900">{t('newFeedback')}</h2>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-bold text-slate-700">{t('previousChoices')}</span>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white rounded-xl p-3 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium text-slate-600">{t('retentionRatio')}</span>
          ...
          {previousFeedback.specificScents.length > 0 && (
            <div className="bg-white rounded-xl p-3 shadow-sm">
              <span className="text-xs font-medium text-slate-600 block mb-2">{t('addedScentsLabel')}</span>
      ...
      >
        <div className="flex items-center gap-1 bg-slate-100 rounded-full px-4 py-2">
          ...
          <span className="text-[10px] text-slate-600 font-medium mx-1">{t('flowRatio')}</span>
          ...
          <span className="text-[10px] text-slate-600 font-medium">{t('flowScent')}</span>
          <span className="text-slate-300">→</span>
          ...
          <span className="text-[10px] text-slate-600 font-medium">{t('flowRecipe')}</span>
        </div>
      </motion.div>
