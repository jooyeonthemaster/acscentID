    ...
    return (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute inset-0 bg-[#393939]/40 backdrop-blur-xl z-10"
            />
            ...
            <motion.div
                ...
                animate={{ opacity: doorState === 'opening' ? 0 : 1 }}
                transition={{ duration: 0.3 }}
                className="absolute inset-0 bg-gradient-to-br from-[#393939]/20 via-transparent to-[#393939]/20 z-10"
            />
            ...
            <div className="absolute inset-0 z-30 pointer-events-none flex flex-col items-center justify-between pt-[20vh] pb-[10vh]">
                ...
                >
                    ...
                    <motion.p
                        className="text-white/70 text-[11px] lg:text-[13px] mb-8 uppercase tracking-[0.3em] font-light"
                    >
                    ...
                    <div className="bg-white/5 backdrop-blur-xl rounded-[6px] p-8 border border-white/10 shadow-2xl text-center relative">
                        ...
                        <AnimatePresence>
                            {isComplete && (
                                ...
                                >
                                    <span className="text-[#B3B3B3] font-black text-[10px] lg:text-[12px] uppercase tracking-[0.4em] block">
                                        ANALYSIS COMPLETE
                                    </span>
                                </motion.div>
                            )}
