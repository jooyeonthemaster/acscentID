                    ...
                    <div className="flex gap-2">
                        {GENDER_OPTIONS_TRANSLATED.map(({ key, label }) => (
                            <motion.button
                                ...
                                className={`relative flex-1 py-3.5 rounded-[6px] text-sm lg:text-base font-semibold transition-all duration-300 overflow-hidden backdrop-blur-md border ${
                                    formData.gender === key
                                        ? "text-[var(--ink)] shadow-lg border-[#393939]"
                                        : "bg-[var(--paper)]/80 text-[var(--muted-ink)] border-white/60 shadow-md shadow-stone-900/5 hover:bg-[var(--paper)]/90 hover:border-[var(--line)]"
                                }`}
                            >
                                {formData.gender === key && (
                                    <motion.div
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {GRADUATION_TYPES_TRANSLATED.map(({ key, label, emoji }) => (
                            <motion.button
                                ...
                                className={`relative py-3 px-2 rounded-[6px] text-xs lg:text-sm font-semibold transition-all duration-300 overflow-hidden backdrop-blur-md border ${
