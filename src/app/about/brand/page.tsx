          ...
          <div className="space-y-8">
            ...
            <div className="p-8 bg-yellow-50 border-2 border-black rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-2xl font-black text-slate-900 mb-3">덕질을 향기로 기록하다</h3>
            ...
            <div className="p-8 bg-purple-50 border-2 border-black rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-2xl font-black text-slate-900 mb-3">모두가 자신만의 향을 가질 권리</h3>
                  <p className="text-slate-600 leading-relaxed text-lg">
            ...
            <div className="p-8 bg-pink-50 border-2 border-black rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-2xl font-black text-slate-900 mb-3">기술과 감성의 만남</h3>
                  <p className="text-slate-600 leading-relaxed text-lg">
      ...
      <section className="relative py-20 px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Value 1 */}
            <motion.div variants={fadeInUp} className="relative p-8 bg-white border-2 border-black rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-[2px] hover:-translate-y-[2px] transition-all">
            ...
            <motion.div variants={fadeInUp} className="relative p-8 bg-white border-2 border-black rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-[2px] hover:-translate-y-[2px] transition-all">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="text-2xl font-black text-slate-900 mb-3">접근성</h3>
              <p className="text-slate-600 leading-relaxed">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <motion.div variants={fadeInUp} className="text-center">
              <div className="text-4xl font-black text-slate-900 mb-2">10,000+</div>
              <div className="text-sm font-bold text-slate-600">분석 완료</div>
            </motion.div>

            <motion.div variants={fadeInUp} className="text-center">
              <div className="text-4xl font-black text-slate-900 mb-2">맞춤</div>
              <div className="text-sm font-bold text-slate-600">향수 레시피</div>
            </motion.div>

            <motion.div variants={fadeInUp} className="text-center">
              <div className="text-4xl font-black text-slate-900 mb-2">95%</div>
              <div className="text-sm font-bold text-slate-600">만족도</div>
            </motion.div>

            <motion.div variants={fadeInUp} className="text-center">
              <div className="text-4xl font-black text-slate-900 mb-2">3가지</div>
              <div className="text-sm font-bold text-slate-600">프로그램</div>
            </motion.div>
          </div>
        </motion.div>
      </section>
