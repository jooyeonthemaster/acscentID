    ...
    const fetchFeedbacks = async () => {
      ...
      try {
        ...
        if (data.success) {
          ...
          setError(data.error || '피드백을 불러오지 못했어요')
        }
      } catch (err) {
              ...
              {showRecipeConfirm && selectedFeedback ? (
                ...
                <>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-slate-900">피드백 히스토리</h2>
                      <p className="text-xs text-slate-500">내가 남긴 커스텀 레시피들</p>
                    </div>
                  </div>
                  <button
                    onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
              ...
              {!showRecipeConfirm && !loading && !error && feedbacks.length === 0 && (
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="text-lg font-bold text-slate-700 mb-2">아직 피드백이 없어요!</h3>
                          ...
                          <div className="flex items-center gap-2 text-xs text-slate-500">
                            ...
                            {feedback.generatedRecipe && (
                              <>
                                ...
                                <span>
                                  {(feedback.generatedRecipe as GeneratedRecipe).totalDrops || 0}방울
                                </span>
                              </>
                            )}
                          </div>
                            ...
                            <div className="px-4 pb-4 space-y-3">
                              ...
                              <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-xs font-bold text-slate-600">레시피 구성</span>
                                </div>
