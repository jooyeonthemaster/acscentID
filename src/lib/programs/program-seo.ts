...
const PROGRAM_SEO: Record<Locale, Record<ProgramSeoSlug, ProgramSeoText>> = {
  ko: {
    ...
    saju: {
      title: '사주 분석 퍼퓸&디퓨저 클리커 키링',
      description: '생년월일시로 읽는 운명의 향. 만세력 기반 사주 분석으로 일간·오행·용신을 풀어내고, 맞춤 퍼퓸(10ml/50ml) 또는 오행 디퓨저 클리커 키링으로 제작합니다. 명식 분석보고서 포함.',
      productDescription: '생년월일시 기반 사주 분석으로 제작하는 맞춤 퍼퓸 또는 오행 디퓨저 클리커 키링. 명식 분석보고서 포함.',
      keywords: ['사주 향수', '사주 분석 퍼퓸&디퓨저 클리커 키링', '오행 향수', '용신 향수', '운세 향수', '최애 사주', '맞춤 향수', '디퓨저 클리커 키링'],
      programLabel: '프로그램',
    },
  },
  en: {
    ...
    saju: {
      title: 'Saju Analysis Perfume & Diffuser Clicker Keyring',
      description: 'A scent read from the moment you were born. We interpret your Saju day master, five elements, and useful element, then create either a custom perfume or a five-element diffuser clicker keyring. Includes a printed chart analysis report.',
      productDescription: 'A custom perfume or five-element diffuser clicker keyring prescribed from your Korean Four Pillars (Saju) birth chart, with a printed analysis report.',
  ...
  ja: {
    ...
    saju: {
      title: '四柱分析パフューム&ディフューザークリッカーキーリング',
      description: '生年月日時から読み解く運命の香り。日干・五行・用神を分析し、オーダーメイドパフュームまたは五行ディフューザークリッカーキーリングとして制作します。命式分析レポート付き。',
      productDescription: '四柱推命の命式から制作するオーダーメイドパフュームまたは五行ディフューザークリッカーキーリング。命式分析レポート付き。',
  ...
  zh: {
    ...
    saju: {
      title: '四柱分析香水&扩香点击器钥匙扣',
      description: '用出生年月日时读出的命运之香。解析你的日主、五行与用神，并制作成定制香水或五行扩香点击器钥匙扣，附命盘分析报告。',
      productDescription: '依据四柱八字命盘制作的定制香水或五行扩香点击器钥匙扣，附命盘分析报告。',
  ...
  es: {
    ...
    saju: {
      title: 'Perfume de Análisis Saju & Llavero Difusor Clicker',
      description: 'Un aroma leído desde tu nacimiento. Interpretamos tu carta Saju, los cinco elementos y el elemento útil para crear un perfume personalizado o un llavero difusor clicker de cinco elementos. Incluye informe de análisis.',
      productDescription: 'Un perfume personalizado o llavero difusor clicker de cinco elementos creado a partir de tu carta Saju, con informe físico de análisis.',
