...

{
  ...
  "matchingPerfumes": [
    {
      ...
      "usageGuide": {
        ...
        "tips": [
          ...
          "리바이 피규어나 굿즈 정리할 때 이 향 뿌려놓으면 진심 리바이가 내 방에 있는 것 같은 몰입감! 🖤 분위기 퀄리티 상승 보장!",
  ...
  "comparisonAnalysis": {
    ...
    "userInputSummary": "스타일로 '시크한' + '카리스마' 골랐고, 성격은 '차가운' + '책임감 있는' 선택함! 매력 포인트는 '눈빛' + '갭모에'! 🖤⚔️ 우리 리바이는 냉철한 전사 + 숨은 따뜻함!",
    "reflectionDetails": "분석 들어간다! 🔥\\\\n\\\\n【ㅇㅈ 포인트】'시크한' 골랐는데 ㄹㅇ 인정! 이미지 속 표정이랑 눈빛에서 시크함 폭발해! 💯 '카리스마'도 군복이랑 무기 든 포즈에서 완전 느껴짐! '차가운' 성격? 무표정인 거 보면 100% ㅇㅈ! '눈빛' 매력 포인트는 진짜 센스야! 사진에서 눈빛이 제일 강렬함!\\\\n\\\\n【숨은 매력 발견】선택 안 했는데 나는 이미지에서 '고독함' 발견! 🌙 혼자 서 있는 포즈에서 외로움이 느껴져! 그리고 '결단력' 있어 보여! 자세가 흔들림 없이 단단함!\\\\n\\\\n【갭 분석】'갭모에' 골랐는데 이미지만 보면 차가움만 보여! 근데 그래서 더 갭모에가 터지는 거지! 평소에 이렇게 차가운 애가 가끔 보여주는 따뜻함이 치명적인 거잖아!\\\\n\\\\n【최종 향수 매칭】시크한 이미지(AI) + 차가운 카리스마 + 숨은 고독함(AI 발견) + 갭모에 = AC'SCENT 21 사이프러스 우디 향 개찰떡! 🌲🖤 시원한 사이프러스는 차가운 첫인상을, 깊은 우디는 묵직한 카리스마를, 따뜻한 앰버 베이스는 숨은 인간미를 표현! 리바이 그 자체! 💕✨"
  }
}
  ...
  "matchingPerfumes": [
    {
      ...
      "matchReason": "히나타의 눈웃음 지을 때 반짝이는 눈빛이랑 이 스트로베리 향의 달콤함이 완전 싱크로! 🍓✨ 코트에서 점프할 때의 에너지가 이 상큼한 향 그대로야!",
      "noteComments": {
        "top": "히나타가 경기장에 등장할 때 눈이 반짝이는 그 순간! 👋💕 이 베르가못 탑노트의 상큼한 첫인상이 히나타 등장신이야! 보자마자 행복해지는 마법! ✨",
        "middle": "히나타가 동료들이랑 하이파이브할 때! 🥹💕 이 달콤한 스트로베리 향이 그 따뜻한 팀워크의 순간이야!",
        "base": "히나타가 경기 끝나고 진지하게 다짐하는 모습! 😢 장난기 많던 애가 갑자기 진지해지는 반전! 이 머스크 베이스가 히나타의 깊은 면!"
      },
      "usageGuide": {
        "situation": "히나타처럼 도전할 일 앞두고 뿌려! 🏐💕 운동할 때 이 향 맡으면 에너지 뿜뿜! 아니면 애니 볼 때! 달콤한 향 맡으면서 히나타 활약 보면 천국! 🍓✨",
        "tips": [
          "히나타가 점프할 때 손짓 따라하면서 손목에 뿌려! 💃 그 열정적이면서도 귀여운 느낌이 향으로 전해져!",
          "히나타 굿즈 정리할 때 이 향 뿌려놓으면 굿즈 속 히나타가 더 반짝반짝 빛나 보여! ✨ 분위기 업!",
          "우울한 날 히나타처럼 긍정 에너지 얻고 싶을 때! 🌸 이 향이 히나타의 밝은 기운 빌려줄 거야!"
        ]
      }
    }
  ]
